...
function showFormData() {
    ...
    if (displayElement) {
        ...
        displayElement.innerHTML += `<div>
                        <button style="display: flex; justify-content: center; align-items: center;" class="AfterSubBtn" id="copyToClipboardBtn"><img src="Files/copy.png" style="width: 20px; margin-right: 5px;" alt="">Copy</button>
                        <button style="display: flex; justify-content: center; align-items: center;" class="AfterSubBtn" id="openWhatsAppBtn"><img src="Files/WaIcon.png" style="width: 25px; margin-right: 5px;" alt=""> WhatsApp</button>
                    </div>
        `;
